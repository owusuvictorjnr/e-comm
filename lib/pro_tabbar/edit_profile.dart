...
class _EditProfileScreenState extends State<EditProfileScreen> {
  ...
  // ignore: slash_for_doc_comments
  /**********************************************************
      ###### FOR VALIDATING AND SUBMITTING UPDATED INFO ######
   *********************************************************/
  validateAndUpdateProfile(){
    ...
    /* THIS IS FOR IMAGE BUT AM NO LONGER USING IT */
  // uploadImage () async{
  ...
  Future saveUserInfo(){
    ...
    // ===> THE UPDATING OF DATA STARTS FROM HERE <===
    return db.doc(user.uid).collection("Profile").doc(user.uid).update({
      "User Name": name,
      "Phone Number": mobile,
      "Location": location,
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: MaterialButton(
                                onPressed: validateAndUpdateProfile,
