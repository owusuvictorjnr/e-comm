...
class CreateClothesUploadForm extends StatefulWidget {
  @override
  _CreateClothesUploadFormState createState() =>
      _CreateClothesUploadFormState();
}

class _CreateClothesUploadFormState extends State<CreateClothesUploadForm> {
  ...
  Future<String> uploadingImage(File imageFile) async {
    ...
    FirebaseStorage.instance.ref().child("clothes");
  ...
  saveProductInfo(String downloadUrl) {
    final productRef = FirebaseFirestore.instance.collection("clothes");
