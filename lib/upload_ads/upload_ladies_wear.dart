...
class CreateLadiesWearUploadForm extends StatefulWidget {
  @override
  _CreateLadiesWearUploadFormState createState() =>
      _CreateLadiesWearUploadFormState();
}

class _CreateLadiesWearUploadFormState extends State<CreateLadiesWearUploadForm> {
  ...
  Future<String> uploadingImage(File imageFile) async {
    ...
    FirebaseStorage.instance.ref().child("ladies_wear");
  ...
  saveProductInfo(String downloadUrl) {
    final productRef = FirebaseFirestore.instance.collection("ladies_wear");
