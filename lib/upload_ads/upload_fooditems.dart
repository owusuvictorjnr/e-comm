...
class CreateFoodItemsUploadForm extends StatefulWidget {
  @override
  _CreateFoodItemsUploadFormState createState() =>
      _CreateFoodItemsUploadFormState();
}

class _CreateFoodItemsUploadFormState extends State<CreateFoodItemsUploadForm> {
  ...
  Future<String> uploadingImage(File imageFile) async {
    ...
    FirebaseStorage.instance.ref().child("food_items");
  ...
  saveProductInfo(String downloadUrl) {
    final productRef = FirebaseFirestore.instance.collection("food_items");
