...
class CreateLadiesBagsUploadForm extends StatefulWidget {
  @override
  _CreateLadiesBagsUploadFormState createState() =>
      _CreateLadiesBagsUploadFormState();
}

class _CreateLadiesBagsUploadFormState extends State<CreateLadiesBagsUploadForm> {
  ...
  Future<String> uploadingImage(File imageFile) async {
    ...
    FirebaseStorage.instance.ref().child("female_bags");
  ...
  saveProductInfo(String downloadUrl) {
    final productRef = FirebaseFirestore.instance.collection("female_bags");
