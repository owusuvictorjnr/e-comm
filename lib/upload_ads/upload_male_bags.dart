...
class CreateMaleBagsUploadForm extends StatefulWidget {
  @override
  _CreateMaleBagsUploadFormState createState() =>
      _CreateMaleBagsUploadFormState();
}

class _CreateMaleBagsUploadFormState extends State<CreateMaleBagsUploadForm> {
  ...
  Future<String> uploadingImage(File imageFile) async {
    ...
    FirebaseStorage.instance.ref().child("male_bags");
  ...
  saveProductInfo(String downloadUrl) {
    final productRef = FirebaseFirestore.instance.collection("male_bags");
