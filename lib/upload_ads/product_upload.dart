...
class CreateProductUploadForm extends StatefulWidget {
  @override
  _CreateProductUploadFormState createState() =>
      _CreateProductUploadFormState();
}

class _CreateProductUploadFormState extends State<CreateProductUploadForm> {
  ...
  saveProductInfo(String downloadUrl) {
    ...
    productRef.doc(productId).set({
      ...
      "Product Price": priceController.text, //Convert the price to int
      "Status": 'available',
