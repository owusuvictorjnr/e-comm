...
class CreateUploadProductsForm extends StatefulWidget {
  @override
  _CreateUploadProductsFormState createState() =>
      _CreateUploadProductsFormState();
}

class _CreateUploadProductsFormState extends State<CreateUploadProductsForm> {
