...
class CreateMenShoesUploadForm extends StatefulWidget {
  @override
  _CreateMenShoesUploadFormState createState() =>
      _CreateMenShoesUploadFormState();
}

class _CreateMenShoesUploadFormState extends State<CreateMenShoesUploadForm> {
  ...
  Future<String> uploadingImage(File imageFile) async {
    ...
    FirebaseStorage.instance.ref().child("mens_shoes");
  ...
  saveProductInfo(String downloadUrl) {
    final productRef = FirebaseFirestore.instance.collection("mens_shoes");
